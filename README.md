...
- DRUGA FUNKCIJA KOJU CU KREIRATI TREBA DA UZME PAYLOAD I DA VALIDIRA PAYLOAD AGAINST ID-JEM (POTENCIJALNOG USER-A) ZAJEDNO SA SECRET-OM

**KREIRANJE TOKENA JE SINHRONO ALI VERIFIKACIJA JE ASINHRONA**

## :five: DEFINISEM /utils/auth.ts FAJL

U OVAJ FAJL UVOZIM JSON WEB TOKEN FUNKCIJE, KOJE SAM KREIRAO U PREDHODNOM FAJLU
