 ...
 * @VAZNO
 *
 * NAIME DOSAO SAM DO SLEDECEG REALIZATIONA
 *
 * - JSON WEB TOKEN SE ZA SINGLE PAGE APPS TREBA KORISTITI KAO BEARER U AUTHORIAZATION HEADER-U
 *
 * - ALI KADA BIH POSMATRAO MULTI PAGE APP, ONDA BI SE TOKEN VEROVATN TREBAO SKLADISTITI KAOA samesite secure COOKIE
 *
 * MEDJUTIM OPET TREBAM PROVERITI OVO, POMENUTO
 *
 */