 ...
 * @B
 * 
 * ISTO TO ZELIM DA DEFINISEM HOOK, KOJI BI ISTO URADIO PRILIKOM UPDATING-A SIFRE
 * OVO DRUGO BIH RADIO, KAO (ZA MENE) PODSETNIK U POGLEDU KORISCENJA PRAVILNIH EVENT-OVA
 * 
 * 
 */
...
// ZAPAMTI DA NE SMES MULTIPLE TIMES DA HSH-UJES SIFRU, JER CE TAKO POSTATI NEUPOTREBLJIVA, NECES JE MOCI DECRYPT-OVATI



// ZASTO BI JA KORISTIO OVAJ SLEDECI HOOK, KOJI IMA VEZE SA findOneAndUpdate()    I     findByIdAndUpdate()   METODA
/**
 * @ZATO STO PRILIKOM UPDATEING-A        save      EVENT **NECE** BITI TRIGGERED
 */

// OVAJ HOOK JE IZMEDJU OSTALOG I PODSETNIK ZA ZA MENE DA AKO U KONTROLERU, PRILIKOM QUERY-JA I UPDATE-A ISKORISTIM JEDNU METODU
 ...
 * @VAZNO
 * 
 * OVAKVA METODA SE PRIMENJUJE NAD ONIM OBJEKTOM KOJI PROIZILAZI IZ QUERY-JA
 * 
 * A TO JE          Document      INSTANCA
 * 
 */
...
userSchema.methods.checkPassword = function (password: string) {
  ...
  const encrypted: string = this.password

  // PROVERI AGAINST PASSED IN PASSWORD, UZ POMOC bcrypt

  return new Promise((res, rej) => {

    bcrypt.compare(password, encrypted, (error, same) => {
